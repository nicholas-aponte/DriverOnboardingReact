...
// core components
// import AppNavbarLinks from "components/Navbars/AppNavbarLinks.js";
...
class Sidebar extends React.Component {
  ...
  createLinks = routes => {
    ...
    return routes.map((prop, key) => {
      ...
      if (this.props.isLoggedIn && prop.loggedIn===false) return null;
      if (!this.props.isLoggedIn && prop.loggedIn!==false) return null;
      if (prop.collapse) {
        var st = {};
  ...
  handleNavLinkClick = () => {
    if (window.innerWidth < 960) this.props.handleDrawerToggle();
  }
        ...
        <Hidden mdUp implementation="css">
          ...
          >
            <SidebarWrapper
              ...
              // user={user}
              // headerLinks={<AppNavbarLinks rtlActive={rtlActive} />}
              links={links}
            />
            {image !== undefined ? (
              <div
